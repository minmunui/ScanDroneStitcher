...
parser.add_argument(
    'input_dir', nargs='?',
    help="Directory name including images to stitch", type=str
)
parser.add_argument(
    '--try_cuda',
    action='store',
...
def main():
    ...
    img_names = os.listdir(os.path.join(os.getcwd(), "data", "input", input_dir))
    img_names = [os.path.join(os.getcwd(), "data", "input", input_dir, name) for name in img_names]
    print(img_names)
